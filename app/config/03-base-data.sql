...
-- Statistic
insert into statistic(tablename, statname, value) values('file', 'total_count', '0');
insert into statistic(tablename, statname, value) values('message', 'total_count', '0');
insert into statistic(tablename, statname, value) values('comment', 'total_count', '0');
insert into statistic(tablename, statname, value) values('message', 'blog.total_count', '0');
insert into statistic(tablename, statname, value) values('message', 'project.total_count', '0');
insert into statistic(tablename, statname, value) values('message', 'story.total_count', '0');
insert into statistic(tablename, statname, value) values('message', 'about.total_count', '0');
